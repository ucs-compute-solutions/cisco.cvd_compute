...
|------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|---------------------------------|
| `add_ucs_vlan_to_vnic_api_private_key`                                       | Path to Cisco Intersight API private key file on the host.                              | **Required** (no default)       |
| `add_ucs_vlan_to_vnic_api_key_id`                                            | Cisco Intersight API key ID.                                                            | **Required** (no default)       |
...
* Note: add_ucs_vlan_to_vnic_api_private_key is stored on a file on the host, we expect a path to this file.
