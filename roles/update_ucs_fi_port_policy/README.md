...
|---------------------------------------------------------|--------------------------------------------------------------------|---------------------------------|
| `update_ucs_fi_port_policy_api_private_key`             | Path to Cisco Intersight API private key.                          | **Required** (no default)       |
| `update_ucs_fi_port_policy_api_key_id`                  | Cisco Intersight API key ID.                                       | **Required** (no default)       |
...
| `update_ucs_fi_port_policy_breakout_option`             | Breakout option string. Chosen from: 'BreakoutEthernet10G' Or 'BreakoutEthernet25G'   | None         |
